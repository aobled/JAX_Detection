...
- ~~**Validation matérielle réelle de l'amendement AD-4 (BatchNorm/LayerNorm)**~~ — fait (Aymeric, Colab TPU v5, FIGHTERJET_CLASSIFICATION, 2026-08-17). Résultat : +2,0% de vitesse (8.62 vs 8.44 it/s), écart d'accuracy -0,20pt (0.9439 vs 0.9459), dans le bruit normal — train accuracy identique aux mêmes epochs. Amendement pleinement validé.
